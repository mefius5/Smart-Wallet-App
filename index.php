      ...
      <div class="row">
          <div class="col-lg-12">
             <div id="content">
                  ...
                  <hr>
                  <button class="btn btn-default btn-lg"><i class="fas fa-dollar-sign"></i> Get Started!</button>&nbsp;&nbsp;&nbsp;&nbsp;
                  <button class="btn btn-default btn-lg"><i class="fa fa-user"></i> Login</button> 
             </div>
